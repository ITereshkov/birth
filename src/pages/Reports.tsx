...
export const Reports = () => {
  ...
  return <div className="space-y-3 pb-4">
    ...
    {generated && <>
      <Card><h3 className="mb-2 font-semibold">Расходы по категориям</h3><div className="h-52"><ResponsiveContainer><PieChart><Pie data={data.pie} dataKey="amount" nameKey="name" /></PieChart></ResponsiveContainer></div></Card>
